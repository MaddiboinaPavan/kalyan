...
public class JCN_FLOW_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			// Connection to Database
						Connection conn = getJDBCType4Connection("JCN_POLICY_NAME", JDBC_TransactionType.MB_TRANSACTION_AUTO);
					...
					MbElement outRoot = outAssembly.getMessage().getRootElement().createElementAsLastChild(MbXMLNSC.PARSER_NAME).createElementAsLastChild(MbElement.TYPE_NAME, "Response",null );
					  while(rs.next()){
						...
						outRoot.createElementAsLastChild(MbElement.TYPE_NAME_VALUE,"BRANCH",BRANCH);
